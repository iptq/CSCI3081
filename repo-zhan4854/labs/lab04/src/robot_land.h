...
class RobotLand {
   public:
    RobotLand(void) {
        sim_time_ = 0.0;
        this->robots.push_back(new Robot(1.0));
        this->robots.push_back(new Robot(0.75));
    }
    void changeColors();
     ...
     *
     * This function will be used mainly for testing purposes, as time flows in
     * a
    ...
    /**
     * @brief Get the angle of the specified robots sensor, in radians.
     * Currently
     * a stub.
     *
     * @todo: Actually implement this.
